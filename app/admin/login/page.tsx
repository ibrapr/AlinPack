...
export default async function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-hero text-brand-black overflow-hidden">
      ...
      <div className="relative w-full max-w-md mx-auto px-6 py-12 animate-fade-in-up">
        <div className="flex items-center gap-2 text-brand-gray-700 text-xs font-semibold uppercase tracking-[0.18em]">
          <span className="h-px w-8 bg-brand-red" />
          Admin
        </div>
        <h1 className="mt-4 text-3xl sm:text-4xl font-bold tracking-tight">Sign in</h1>
        <p className="mt-3 text-sm text-brand-gray-700">
